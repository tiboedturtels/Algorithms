...
namespace Dijkstra_sKattis
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (line != "0 0 0 0")
            {
                ...
                Dijkstras(Nodes, startIndex, numQueries, Output);
        ...
        static void Dijkstras(Node[] Nodes, int StartingIndex, int numQueries, StringBuilder output)
        {
            //Set up
            ...
            for (int i = 0; i < numQueries; i++)
            {
                ...
                if (dist[checkIndex] == int.MaxValue)
                    output.Append("Impossible" + System.Environment.NewLine);
                else
                    output.Append(dist[checkIndex] + System.Environment.NewLine);
            }
    ...
    class BinaryHeap
    {
        ...
        public Node Pop()
        {
            ...
            if(!isEmpty())
                PQIndices[heap[0].Data.ListIndex] = 0;
        ...
        private void swap(int i1, int i2)
        {
            ...
            int tempPQIndex = PQIndices[heap[i1].Data.ListIndex];

            PQIndices[heap[i1].Data.ListIndex] = PQIndices[heap[i2].Data.ListIndex];
            heap[i1] = heap[i2];

            PQIndices[heap[i2].Data.ListIndex] = tempPQIndex;
            heap[i2] = temp;
        }
